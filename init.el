...
you should place your code here."
  ...
  (require 'init-ui)
  (setq custom-file (expand-file-name "~/.spacemacs.d/lisp/Custom.el" dotspacemacs-directory))
