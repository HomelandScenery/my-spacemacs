(custom-set-variables
 ...
 '(cfs--current-profile "kaiti" t)
 '(cfs--profiles-steps (quote (("kaiti" . 5) ("program" . 6))) t)
 '(custom-safe-themes
   (quote
